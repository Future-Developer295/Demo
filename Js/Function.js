...
const data = {
    apartment: {
        ...
        para2: "When you need free CSS templates, you can simply type TemplateMo in any search engine website. In addition, you can type TemplateMo Portfolio."
    },
    villa: {
...
document.querySelectorAll(".deal-info-button button").forEach(btn => {
    btn.addEventListener("click", function () {
        ...
        const imageBox = document.querySelector(".deal-info-image");
        imageBox.style.backgroundImage = `url(${data[type].image})`;
